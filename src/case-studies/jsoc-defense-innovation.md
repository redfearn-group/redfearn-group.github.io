...
<g font-family="IBM Plex Sans, sans-serif">
  ...
  <text x="105" y="136" text-anchor="middle" font-size="12" font-weight="600" fill="#0A1128">or mandate</text>

  <rect x="225" y="88" width="170" height="70" rx="6" fill="#FFFFFF" stroke="#0A1128" stroke-opacity="0.15"/>
  <text x="310" y="118" text-anchor="middle" font-size="12" font-weight="600" fill="#0A1128">Business case built</text>
  <text x="310" y="136" text-anchor="middle" font-size="12" font-weight="600" fill="#0A1128">from scratch</text>

  <rect x="430" y="88" width="150" height="70" rx="6" fill="#FCF4F0" stroke="#D97443" stroke-opacity="0.45"/>
  <text x="505" y="122" text-anchor="middle" font-family="Space Grotesk, sans-serif" font-size="18" font-weight="700" fill="#C2592A">$750K</text>
  <text x="505" y="140" text-anchor="middle" font-size="11" fill="#676E7C">secured</text>

  <path d="M190 123 L223 123" stroke="#C2592A" stroke-width="1.5" marker-end="url(#arrowJsoc)"/>
  <path d="M395 123 L428 123" stroke="#C2592A" stroke-width="1.5" marker-end="url(#arrowJsoc)"/>
  <path d="M580 108 L620 60" stroke="#C2592A" stroke-width="1.5" marker-end="url(#arrowJsoc)"/>
  <path d="M580 138 L620 186" stroke="#C2592A" stroke-width="1.5" marker-end="url(#arrowJsoc)"/>

  <rect x="630" y="20" width="230" height="60" rx="6" fill="#FFFFFF" stroke="#0A1128" stroke-opacity="0.15"/>
  <text x="745" y="55" text-anchor="middle" font-size="13" font-weight="600" fill="#0A1128">Prototype 1</text>
  <rect x="630" y="146" width="230" height="60" rx="6" fill="#FFFFFF" stroke="#0A1128" stroke-opacity="0.15"/>
  <text x="745" y="181" text-anchor="middle" font-size="13" font-weight="600" fill="#0A1128">Prototype 2</text>

  <defs>
    <marker id="arrowJsoc" markerWidth="8" markerHeight="8" refX="4" refY="4" orient="auto">
